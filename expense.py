...
def check_password():
    ...
    if not st.session_state.password_correct:
        st.markdown("<div class='title-gradient'>M37Labs Expense Calculator</div>", unsafe_allow_html=True)
...
# Initialize the app
st.set_page_config(layout="wide", page_title="M37Labs Expense Calculator")
init_styling()
